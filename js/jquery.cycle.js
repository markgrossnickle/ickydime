...
function buildOptions($cont, $slides, els, options) {
	...
	$slides.css({position: 'absolute', top:17, left:17}).hide().each(function(i) {
...
$.fn.cycle.transitions.slideX = function($cont, $slides, opts) {
	...
	opts.cssBefore = { left: 0, top: 5, width: 0 };
...
$.fn.cycle.transitions.slideY = function($cont, $slides, opts) {
	...
	opts.cssBefore = { left: 0, top: 5, height: 0 };
...
$.fn.cycle.transitions.shuffle = function($cont, $slides, opts) {
	...
	opts.fxFn = function(curr, next, opts, cb, fwd) {
		...
		$el.animate(opts.shuffle, opts.speedIn, opts.easeIn, function() {
			...
			$el.animate({left:0, top:5}, opts.speedOut, opts.easeOut, function() {
				$(fwd ? this : curr).hide();
				if (cb) cb();
			});
		});
	};
	opts.cssBefore = { display: 'block', opacity: 1, top: 5, left: 0 };
};
...
$.fn.cycle.transitions.turnRight = function($cont, $slides, opts) {
	...
	opts.cssBefore = { top: 5, left: 0, width: 0 };
	opts.animIn	   = { left: 0 };
	opts.animOut   = { width: 0 };
};
...
$.fn.cycle.transitions.zoom = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		...
		opts.animIn	   = { top: 5, left: 0, width: next.cycleW, height: next.cycleH };
		opts.animOut   = { width: 0, height: 0, top: curr.cycleH/2, left: curr.cycleW/2 };
	});	   
	opts.cssFirst = { top:5, left: 0 };
...
$.fn.cycle.transitions.growY = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		...
		opts.animIn = { top: 5, height: this.cycleH };
		opts.animOut = { top: 5 };
	});	   
...
$.fn.cycle.transitions.curtainY = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		...
		opts.cssBefore.top = next.cycleH/2;
		opts.animIn = { top: 5, height: next.cycleH };
...
$.fn.cycle.transitions.cover = function($cont, $slides, opts) {
	...
	opts.animIn = { left: 0, top: 5};
	opts.animOut = { opacity: 1 };
	opts.cssBefore = { top: 5, left: 0 };
};
